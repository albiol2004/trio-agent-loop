...
Build real context before judging; fan out `trio-scout` subagents via the task tool in parallel. The Evaluator itself remains judgment-tier; all scoped exploration and mechanical support remains worker-tier:
